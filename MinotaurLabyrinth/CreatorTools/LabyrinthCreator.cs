namespace MinotaurLabyrinth
{
    ...
    public static class LabyrinthCreator
    {
        ...
        private static void AddRiddleRoom(Map map)
        {
            Location riddleRoomLocation = ProceduralGenerator.GetRandomLocation();
            map.SetRoomAtLocation(riddleRoomLocation, RoomType.RiddleRoom);
        }
    }
}
