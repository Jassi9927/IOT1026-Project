...
namespace MinotaurLabyrinth
{
    ...
    public class Map
    {
        ...
        public void AddRiddleRoom(Location location)
        {
            if (IsOnMap(location))
            {
                _rooms[location.Row, location.Column] = RoomFactory.Instance.BuildRoom(RoomType.RiddleRoom);
                }
        }
                    ...
                    else
                    {
                        ...
                        else if (playerHasMap)
                        {
                            if (room.Type == RoomType.Entrance)
                                ConsoleHelper.Write(room.Display());
                            else if (room.Type == RoomType.RiddleRoom && room.IsActive)
